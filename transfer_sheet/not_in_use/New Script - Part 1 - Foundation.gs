 ...
 * ============================================================================
 * Version: 2.0 | Created: 2025-11-24
 */
...
function onOpen() {
  ...
  ui.createMenu("Budget Management")
    ...
    .addSubMenu(ui.createMenu("💰 IN/OUT")
    ...
    .addSubMenu(ui.createMenu("📈 Reports")
      ...
      .addItem("Transfer Request", "generateItemizedTransferRequest"))
...
function validateAllData() {
  ...
  if (errors.length === 0) {
    ui.alert('Validation Complete', 'All checks passed!', ui.ButtonSet.OK);
  } else {
